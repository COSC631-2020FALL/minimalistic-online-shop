<div class="row">
    ...
    <div class="col-md-6">
        <span class="form-group row">Product name</span>

        <span class="form-group row">Quantity 2</span>

        <span class="form-group row">Cost</span>

        <span class="form-group row">
            <form action="{{ route('carts.destroy', 1)}}" method="post">
                @csrf
